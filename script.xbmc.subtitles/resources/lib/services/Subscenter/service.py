...
# 1.5 - Changed add-on to use original title since XBMC doesn't pass non-ascii characters, added User Agent to getURL, added different patterns fo tv/movies, fixed string related bugs
#
